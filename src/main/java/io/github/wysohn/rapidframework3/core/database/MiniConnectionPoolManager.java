 ...
 * <p>
 * Home page: <a href=
 * "http://www.source-code.biz/miniconnectionpoolmanager">www.source-code.biz/miniconnectionpoolmanager</a><br>
...
public class MiniConnectionPoolManager {
     ...
     *
     * <p>
     * This method is slower than {@link #getConnection()} because the JDBC driver
     * has to send an extra command to the database server to test the connection.
     *
     * <p>
     ...
     *
     * <p>
     * This is the number of <code>Connection</code> objects that have been issued
     * by {@link #getConnection()}, for which <code>Connection.close()</code> has
     * not yet been called.
     *
     ...
     * <code>Connection.close()</code> has been called and which have not yet been
     * reused.
     *
    ...
    /**
     * Thrown in {@link #getConnection()} or {@link #getValidConnection()} when no
     * free connection becomes available within <code>timeout</code> seconds.
     */
