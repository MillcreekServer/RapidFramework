...
public class JarUtil {
    ...
    public static void copyFolderFromJar(String folderName, File destFolder, CopyOption option, PathTrimmer trimmer)
            throws IOException {
        copyFolderFromJar(JarUtil.class, folderName, destFolder, option, null);
    }

    public static void copyFolderFromJar(Class<?> clazz, String folderName, File destFolder, CopyOption option, PathTrimmer trimmer)
            throws IOException {
