...
public class BukkitUtil {
    ...
    /**
     * Get list of players. For old version like 1.5.2, the return value of
     * Bukkit.getOnlinePlayers() is array instead of Collection. For that case, this
    ...
    /**
     * Check if the provided PlayerInteractEvent is caused by main hand. For the old
