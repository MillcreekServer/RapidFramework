...
public abstract class AbstractManagerGroup<PB extends PluginBase, V extends Group>
    ...
    protected abstract V instantiateGroup(UUID ownerUuid);

    /**
     * Attempt to create a new group with given name and owner set to the given
     * UUID
     *
    ...
    public boolean create(String name, UUID ownerUuid, GroupHandle<V> onFinish) {
        ...
        group = instantiateGroup(ownerUuid);
