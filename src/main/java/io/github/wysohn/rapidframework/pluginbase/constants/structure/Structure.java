package io.github.wysohn.rapidframework.pluginbase.constants.structure;
...
public abstract class Structure implements NamedElement {
    ...
    public void applyInfoMap(Player player, Map<Language, Object> map, NameToUUIDParser parser) throws StructureException{
