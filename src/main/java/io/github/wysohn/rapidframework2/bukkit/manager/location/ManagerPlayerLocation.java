 ...
 *******************************************************************************/
package io.github.wysohn.rapidframework2.bukkit.manager.location;

import io.github.wysohn.rapidframework2.bukkit.main.events.PlayerBlockLocationEvent;
import io.github.wysohn.rapidframework2.bukkit.main.events.PlayerChunkLocationEvent;
...
public class ManagerPlayerLocation extends PluginMain.Manager {
    private static PlayerTracker TRACKER;

    public ManagerPlayerLocation(int loadPriority) {
        super(loadPriority);
    }
