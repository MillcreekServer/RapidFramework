package io.github.wysohn.rapidframework2.bukkit.manager.task;
 ...
 * @author wysohn
 */
public class ManagerLazyTask extends PluginMain.Manager {
    ...
    public ManagerLazyTask(int loadPriority) {
        super(loadPriority);
    }
