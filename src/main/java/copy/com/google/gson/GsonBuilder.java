...
import copy.com.google.gson.internal.$Gson$Preconditions;
import copy.com.google.gson.internal.Excluder;
import copy.com.google.gson.internal.bind.TreeTypeAdapter;
...
import static copy.com.google.gson.Gson.*;
...
public final class GsonBuilder {
     ...
     * GsonBuilder has the same configuration as the previously built Gson instance.
     *
     * @param gson the gson instance whose configuration should by applied to a new
     *             GsonBuilder.
     */
     ...
     *
     * @param ignoreVersionsAfter any field or type marked with a version higher
     ...
     *
     * <p>
     * The date format will be used to serialize and deserialize {@link Date},
     * {@link Timestamp} and {@link java.sql.Date}.
     *
     * <p>
     ...
     * {@code DateFormat} class. See the documentation in {@link DateFormat} for
     * more information on the valid style constants.
     * </p>
     *
     ...
     * processed. Gson is designed to gamehandle a large number of factories, so you
     ...
     *                    for the base class or interface
