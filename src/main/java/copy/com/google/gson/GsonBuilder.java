...
public final class GsonBuilder {
    ...
    /**
     * Constructs a GsonBuilder instance from a Gson instance. The newly
     * constructed GsonBuilder has the same configuration as the previously
     * built Gson instance.
     *
     * @param gson
     *            the gson instance whose configuration should by applied to a
     *            new GsonBuilder.
     */
     ...
     * makes the parser liberal in what it accepts.
     *
     * @return a reference to this {@code GsonBuilder} object to fulfill the
     *         "Builder" pattern
