...
package copy.com.google.gson;

import copy.com.google.gson.internal.ConstructorConstructor;
import copy.com.google.gson.internal.Excluder;
import copy.com.google.gson.internal.Primitives;
import copy.com.google.gson.internal.Streams;
import copy.com.google.gson.internal.bind.*;
...
import copy.com.google.gson.stream.MalformedJsonException;
 ...
 * @author Joel Leitch
 * @author Jesse Wilson
 * @see copy.com.google.gson.reflect.TypeToken
 */
public final class Gson {
     ...
     * {@link java.util.Locale}, {@link java.util.Date}, {@link BigDecimal}, and
     * {@link BigInteger} classes. If you would prefer to change the default
     * representation, you can do so by registering a type adapter through
     * {@link GsonBuilder#registerTypeAdapter(Type, Object)}.</li>
     * <li>The default Date format is same as {@link DateFormat#DEFAULT}. This
     * format ignores the millisecond portion of the date during serialization. You
     * can change this by invoking {@link GsonBuilder#setDateFormat(int)} or
     * {@link GsonBuilder#setDateFormat(String)}.</li>
     * <li>By default, Gson ignores the
     * {@link copy.com.google.gson.annotations.Expose} annotation. You can enable
     * Gson to serialize/deserialize only those fields marked with this annotation
     * through {@link GsonBuilder#excludeFieldsWithoutExposeAnnotation()}.</li>
     * <li>By default, Gson ignores the
     * {@link copy.com.google.gson.annotations.Since} annotation. You can enable
     * Gson to use this annotation through
     ...
     */
    public Gson() {
        this(Excluder.DEFAULT, FieldNamingPolicy.IDENTITY, Collections.<Type, InstanceCreator<?>>emptyMap(),
                DEFAULT_SERIALIZE_NULLS, DEFAULT_COMPLEX_MAP_KEYS, DEFAULT_JSON_NON_EXECUTABLE, DEFAULT_ESCAPE_HTML,
                DEFAULT_PRETTY_PRINT, DEFAULT_LENIENT, DEFAULT_SPECIALIZE_FLOAT_VALUES, LongSerializationPolicy.DEFAULT,
                null, DateFormat.DEFAULT, DateFormat.DEFAULT, Collections.<TypeAdapterFactory>emptyList(),
    ...
    Gson(final Excluder excluder, final FieldNamingStrategy fieldNamingStrategy,
         ...
         LongSerializationPolicy longSerializationPolicy, String datePattern, int dateStyle, int timeStyle,
         List<TypeAdapterFactory> builderFactories, List<TypeAdapterFactory> builderHierarchyFactories,
        ...
        factories.add(new ReflectiveTypeAdapterFactory(constructorConstructor, fieldNamingStrategy, excluder,
                jsonAdapterFactory));
     ...
     *                  type by using the
     *                  {@link copy.com.google.gson.reflect.TypeToken} class. For
     *                  example, to get the type for {@code Collection<Foo>}, you
     *                  should use:
     *
     *                  <pre>
     ...
     * @param <T>     the type of the desired object
     * @param json    the string from which the object is to be deserialized
     * @param typeOfT The specific genericized type of src. You can obtain this type
     *                by using the {@link copy.com.google.gson.reflect.TypeToken}
