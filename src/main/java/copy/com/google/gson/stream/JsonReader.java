...
package copy.com.google.gson.stream;

import copy.com.google.gson.internal.JsonReaderInternalAccess;
import copy.com.google.gson.internal.bind.JsonTreeReader;
...
public class JsonReader implements Closeable {
    ...
    /**
     * Returns the next token, a {@link copy.com.google.gson.stream.JsonToken#NAME
    ...
    /**
     * Returns the {@link copy.com.google.gson.stream.JsonToken#STRING string} value
     * of the next token, consuming it. If the next token is a number, this method
     * will return its string form.
     *
     * @throws IllegalStateException if the next token is not a string or if this
     *                               reader is closed.
     */
    ...
    /**
     * Returns the {@link copy.com.google.gson.stream.JsonToken#BOOLEAN boolean}
     * value of the next token, consuming it.
     *
     * @throws IllegalStateException if the next token is not a boolean or if this
     *                               reader is closed.
     */
     ...
     * null.
     *
     * @throws IllegalStateException if the next token is not null or if this reader
     *                               is closed.
     */
    ...
    /**
     * Returns the {@link copy.com.google.gson.stream.JsonToken#NUMBER double} value
     ...
     * @throws NumberFormatException if the next literal value cannot be parsed as a
     *                               double, or is non-finite.
     */
    ...
    /**
     * Returns the {@link copy.com.google.gson.stream.JsonToken#NUMBER long} value
     * of the next token, consuming it. If the next token is a string, this method
     * will attempt to parse it as a long. If the next token's numeric value cannot
     * be exactly represented by a Java {@code long}, this method throws.
     *
     * @throws IllegalStateException if the next token is not a literal value.
     * @throws NumberFormatException if the next literal value cannot be parsed as a
     *                               number, or exactly represented as a long.
     */
    ...
    /**
     * Returns the {@link copy.com.google.gson.stream.JsonToken#NUMBER int} value of
     ...
     * @throws IllegalStateException if the next token is not a literal value.
     * @throws NumberFormatException if the next literal value cannot be parsed as a
     *                               number, or exactly represented as an int.
     */
