...
public class JsonReader implements Closeable {
     ...
     * {@link copy.com.google.gson.stream.JsonToken#NAME property name}, and
     * consumes it.
     *
     * @throws IOException
    ...
    /**
     * Returns the {@link copy.com.google.gson.stream.JsonToken#STRING string}
     * value of the next token, consuming it. If the next token is a number,
     * this method will return its string form.
     *
    ...
    /**
     * Returns the {@link copy.com.google.gson.stream.JsonToken#NUMBER double}
     * value of the next token, consuming it. If the next token is a string,
     * this method will attempt to parse it as a double using
    ...
    /**
     * Returns the {@link copy.com.google.gson.stream.JsonToken#NUMBER long}
     * value of the next token, consuming it. If the next token is a string,
     * this method will attempt to parse it as a long. If the next token's
     * numeric value cannot be exactly represented by a Java {@code long}, this
     * method throws.
     *
     * @throws IllegalStateException
     *             if the next token is not a literal value.
    ...
    /**
     * Returns the {@link copy.com.google.gson.stream.JsonToken#NUMBER int}
     * value of the next token, consuming it. If the next token is a string,
     * this method will attempt to parse it as an int. If the next token's
     * numeric value cannot be exactly represented by a Java {@code int}, this
     * method throws.
     *
     * @throws IllegalStateException
     *             if the next token is not a literal value.
