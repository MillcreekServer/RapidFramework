package copy.com.google.gson.internal.bind.util;
...
public class ISO8601Utils {
     ...
     * @param pos  The position to start parsing from, updated to where parsing
     *             stopped.
	...
	try {
		...
		// When timezone has no minutes, we should append it, valid
		// timezones are, for example: +00:00, +0000 and +00
