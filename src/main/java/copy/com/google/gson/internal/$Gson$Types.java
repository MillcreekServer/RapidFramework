...
package copy.com.google.gson.internal;

import java.io.Serializable;
import java.lang.reflect.*;
import java.util.*;

import static copy.com.google.gson.internal.$Gson$Preconditions.checkArgument;
import static copy.com.google.gson.internal.$Gson$Preconditions.checkNotNull;
...
public final class $Gson$Types {
    ...
    static Type getSupertype(Type context, Class<?> contextRawType, Class<?> supertype) {
        if (context instanceof WildcardType) {
            // wildcards are useless for resolving supertypes. As the upper
            // bound has the same raw type, use it instead
